; Ex4.asm  ---- Example program 4 for the DRAGON12-Light Rev. A board
;               (c)2014, EVBplus.com
;     Author: Wayne Chu
;     Date: 4/19/14
;
...
;
; Binary number:                 $00,$01,$02,$03,$04,$05,$06,$07,$08
; Converted to 7-segment char:    0,  1,  2,  3,  4,  5,  6,  7,  8

; Binary number9:		 $09,$0A,$0B,$0C,$0D,$0E,$0F
; Converted to 7-segment char:	  9,  A,  B,  C,  D,  E,  F
;
...
;                 8,  9,  A,  b,  C,  d,  E,  F
        fcb     $3d,$76,$74,$1e,$38,$54,$63,$5c                ; 10-17		L = $14 H = $11 P = $18 E = 0E
;                 G,  H,  h,  J   L   n   o   o
...
;            if no key is down the carry bit =0
...
was_set:
	...
	stab    disp_data+3	; sends pressed char to last 7-segment display
	ldab	#$20
        stab    disp_data	; sends blank char to first 3 7-segment displays
        stab    disp_data+1
        stab    disp_data+2
        jmp     dead_key
...
;I changed the order the character pressed was sent to the display such that the actual
;char pressed would go to the last display first and the other 3 would be sent the blank 
;character. 